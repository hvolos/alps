...
#ifndef MERGE_SORT_KEY_POSITION_TRACKER_WITH_LONG_KEYS_H_
#define MERGE_SORT_KEY_POSITION_TRACKER_WITH_LONG_KEYS_H_
...
#endif /*MERGE_SORT_KEY_POSITION_TRACKER_WITH_LONG_KEYS_H_*/
