...
KeyWithVariableLength::RetrievedMapBucket ReduceShuffleStoreWithStringKey::retrieve_mapbucket(int mapId){
  //CHECK(mapId <totalNumberOfPartitions);
  CHECK(mapId < reduceStatus.getSizeOfMapBuckets());
	
  KeyWithVariableLength::RetrievedMapBucket result(reducerId, mapId);
...
void ReduceShuffleStoreWithStringKey::free_retrieved_mapbucket(
                       KeyWithVariableLength::RetrievedMapBucket &mapBucket){
...
KeyWithVariableLength::MergeSortedMapBuckets 
           ReduceShuffleStoreWithStringKey::retrieve_mergesortedmapbuckets () {
  KeyWithVariableLength::MergeSortedMapBuckets result (reducerId);
