...
java -Djava.library.path=/usr/local/lib -Xmx1024m -cp ../ShmShuffleEngine.jar:../extlibs/kryo-3.0.2.jar:../extlibs/reflectasm-1.10.1.jar:../extlibs/minlog-1.3.0.jar:../extlibs/objenesis-2.1.jar:../extlibs/asm-5.0.jar:../extlibs/slf4j-api-1.7.12.jar:../extlibs/slf4j-log4j12-1.7.12.jar:../extlibs/log4j-1.2.17.jar:../extlibs/junit-4.5.jar com.hp.hpl.firesteel.shuffle.SortBasedReduceSHMShuffleStoreWithIntKeysTest
